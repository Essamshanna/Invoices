<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					<li class="side-item side-item-category">منظومة المحاسبة للشركات</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ url('/' . $page='dashboard') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3"/><path d="M3 13h8V3H3v10zm2-8h4v6H5V5zm8 16h8V11h-8v10zm2-8h4v6h-4v-6zM13 3v6h8V3h-8zm6 4h-4V5h4v2zM3 21h8v-6H3v6zm2-4h4v2H5v-2z"/></svg><span class="side-menu__label">الصفحة الرئسية</span></a>
					</li>
                    <li class="side-item side-item-category">تهيئة النظام</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h15v3H5zm12 5h3v9h-3zm-7 0h5v9h-5zm-5 0h3v9H5z" opacity=".3"/><path d="M20 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h15c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM8 19H5v-9h3v9zm7 0h-5v-9h5v9zm5 0h-3v-9h3v9zm0-11H5V5h15v3z"/></svg><span class="side-menu__label">تهيئة النظام</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='companyBranches') }}">بيانات الشركة</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='statuses') }}">الحالة</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='product') }}">إيضافة اصناف</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='currencyType') }}">العملات</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='typees') }}">نوع الحساب</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='natureAccounts') }}">طبيعة الحساب</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='reports') }}">تاثير التقارير</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='cashier') }}">الصناديق</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='bank') }}">البنوك</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='typesOfRestrictions') }}">انوع القيود</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='customersAndSuppliers') }}">العملاء و الموردين</a></li>
						</ul>
					</li>
                    {{-- <li class="side-item side-item-category">الحسابات</li> --}}
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">الحسابات</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='treeAccounts') }}"> عرض شجرة الحسابات</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">دليل الحسابات</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">قيد اليومية العام</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">سند الصرف</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">سند القبظ</a></li>
						</ul>
					</li>
                    ...
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label"> الفوتير</span><i class="angle fe fe-chevron-down"></i></a>
                            <ul class="slide-menu">
                                <li><a class="slide-item" href="{{ url('/' . $page='invoices') }}"> قائمة الفوتير</a></li>
                            </ul>
                    </li>
                    {{-- <li class="side-item side-item-category">الرواتب والموظفين</li> --}}
                    <li class="slide">
                        <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">الرواتب و الموظفين</span><i class="angle fe fe-chevron-down"></i></a>
                            <ul class="slide-menu">
                                <li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">الرواتب</a></li>
                                <li><a class="slide-item" href="{{ url('/' . $page='invoices') }}">الموظفين</a></li>
                            </ul>
                    </li>

                    {{-- <li class="side-item side-item-category">مدراء النظام</li> --}}
                    <li class="slide">
                        <a class="side-menu__item" href="{{ url('/' . $page='manager') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M13 4H6v16h12V9h-5V4zm3 14H8v-2h8v2zm0-6v2H8v-2h8z" opacity=".3"/><path d="M8 16h8v2H8zm0-4h8v2H8zm6-10H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"/></svg><span class="side-menu__label">مدراء النظام</span></a>
                    </li>
					{{-- <li class="side-item side-item-category">تقرير النظام</li> --}}
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">طابعة الدليل المحاسبي</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">كشف حساب</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='rangeslider') }}">حركة الصندوق</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='calendar') }}">ميزان المراجعة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='contacts') }}">الميزانية العمومية</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='image-compare') }}">قائمة الارباح والخساير</a></li>
						</ul>
					</li>
                    {{-- <li class="side-item side-item-category"> المداراء</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M13 4H6v16h12V9h-5V4zm3 14H8v-2h8v2zm0-6v2H8v-2h8z" opacity=".3"/><path d="M8 16h8v2H8zm0-4h8v2H8zm6-10H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"/></svg><span class="side-menu__label">مدراء النظام</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='form-elements') }}">المداراء</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='form-advanced') }}">طلاحيات المداراء</a></li>
						</ul>
					</li> --}}
                    {{-- <li class="side-item side-item-category">الاعدادات</li> --}}
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h15v3H5zm12 5h3v9h-3zm-7 0h5v9h-5zm-5 0h3v9H5z" opacity=".3"/><path d="M20 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h15c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM8 19H5v-9h3v9zm7 0h-5v-9h5v9zm5 0h-3v-9h3v9zm0-11H5V5h15v3z"/></svg><span class="side-menu__label">الاعدادات</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='table-basic') }}">النسخة الاحتياطية</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='table-data') }}">بيانات الشركة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='form-layouts') }}">المستخدمين</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='form-validation') }}">بيانات الاتصال</a></li>
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='rangeslider') }}">rangeslider</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='rating') }}">rating</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='reset') }}">reset</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='search') }}">search</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='signin') }}">signin</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='signup') }}">signup</a></li>
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='table-basic') }}">table-basic</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='table-data') }}">table-data</a></li>
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='welcome') }}">welcome</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='widget-notification') }}">widget-notification</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='widgets') }}">widgets</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='width') }}">width</a></li>
						</ul>
					</li>

                    {{-- <li class="side-item side-item-category">سجلات النظام</li> --}}
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" ><path d="M0 0h24v24H0V0z" fill="none"/><path d="M5 5h15v3H5zm12 5h3v9h-3zm-7 0h5v9h-5zm-5 0h3v9H5z" opacity=".3"/><path d="M20 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h15c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM8 19H5v-9h3v9zm7 0h-5v-9h5v9zm5 0h-3v-9h3v9zm0-11H5V5h15v3z"/></svg><span class="side-menu__label">سجلات النظام</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='table-basic') }}">الحركة اليومية</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='table-data') }}">حركة السجلات</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='form-advanced') }}">form-advanced</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='form-editor') }}">form-editor</a></li>
							...
							<li><a class="slide-item" href="{{ url('/' . $page='index') }}">index</a></li>
							...
							<li><a class="slide-item" href="{{ url('/' . $page='mail-read') }}">mail-read</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='mail-settings') }}">mail-settings</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='mail') }}">mail</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='map-leaflet') }}">map-leaflet</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='map-vector') }}">map-vector</a></li>
							...
							<li><a class="slide-item" href="{{ url('/' . $page='product-cart') }}">product-cart</a></li>

						</ul>
					</li>
                    {{-- <li class="side-item side-item-category">مساعدات</li> --}}
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="side-menu__icon" viewBox="0 0 24 24" ><g><rect fill="none"/></g><g><g/><g><path d="M21,5c-1.11-0.35-2.33-0.5-3.5-0.5c-1.95,0-4.05,0.4-5.5,1.5c-1.45-1.1-3.55-1.5-5.5-1.5S2.45,4.9,1,6v14.65 c0,0.25,0.25,0.5,0.5,0.5c0.1,0,0.15-0.05,0.25-0.05C3.1,20.45,5.05,20,6.5,20c1.95,0,4.05,0.4,5.5,1.5c1.35-0.85,3.8-1.5,5.5-1.5 c1.65,0,3.35,0.3,4.75,1.05c0.1,0.05,0.15,0.05,0.25,0.05c0.25,0,0.5-0.25,0.5-0.5V6C22.4,5.55,21.75,5.25,21,5z M3,18.5V7 c1.1-0.35,2.3-0.5,3.5-0.5c1.34,0,3.13,0.41,4.5,0.99v11.5C9.63,18.41,7.84,18,6.5,18C5.3,18,4.1,18.15,3,18.5z M21,18.5 c-1.1-0.35-2.3-0.5-3.5-0.5c-1.34,0-3.13,0.41-4.5,0.99V7.49c1.37-0.59,3.16-0.99,4.5-0.99c1.2,0,2.4,0.15,3.5,0.5V18.5z"/><path d="M11,7.49C9.63,6.91,7.84,6.5,6.5,6.5C5.3,6.5,4.1,6.65,3,7v11.5C4.1,18.15,5.3,18,6.5,18 c1.34,0,3.13,0.41,4.5,0.99V7.49z" opacity=".3"/></g><g><path d="M17.5,10.5c0.88,0,1.73,0.09,2.5,0.26V9.24C19.21,9.09,18.36,9,17.5,9c-1.28,0-2.46,0.16-3.5,0.47v1.57 C14.99,10.69,16.18,10.5,17.5,10.5z"/><path d="M17.5,13.16c0.88,0,1.73,0.09,2.5,0.26V11.9c-0.79-0.15-1.64-0.24-2.5-0.24c-1.28,0-2.46,0.16-3.5,0.47v1.57 C14.99,13.36,16.18,13.16,17.5,13.16z"/><path d="M17.5,15.83c0.88,0,1.73,0.09,2.5,0.26v-1.52c-0.79-0.15-1.64-0.24-2.5-0.24c-1.28,0-2.46,0.16-3.5,0.47v1.57 C14.99,16.02,16.18,15.83,17.5,15.83z"/></g></g></svg><span class="side-menu__label">مساعدات</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
                            <li><a class="slide-item" href="{{ url('/' . $page='404') }}">404</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='500') }}">500</a></li>
							...
							<li><a class="slide-item" href="{{ url('/' . $page='chart-chartjs') }}">chart-chartjs</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-echart') }}">chart-echart</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">chart-flot</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">chart-morris</a></li>
							...
							<li><a class="slide-item" href="{{ url('/' . $page='dashboard') }}">dashboard</a></li>
                            <li><a class="slide-item" href="{{ url('/' . $page='display') }}">display</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='editprofile') }}">editprofile</a></li>
                    ...
                    {{-- <li class="side-item side-item-category">Custom Pages</li>
					{{-- <li class="slide">
                    ...
                    {{-- <li class="side-item side-item-category">Submenus</li>
					<li class="slide ">
