...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">قائمة الفوتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ إضافة فاتورة</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <select name="Section" class="form-control SlectBox" onclick="console.log($(this).val())"
                                                ...
                                                <!--placeholder-->
                                                <option value="" selected disabled>حدد نوع المنتجات</option>
                                        ...
                                        <div class="col">
                                            <label for="inputName" class="control-label">الاصناف</label>
...
{{--
                                        <div class="col">
                                            ...
                                            <select name="Section1" class="form-control SlectBox" onclick="console.log($(this).val())"
                                                onchange="console.log('change is firing')">
                                                <!--placeholder-->
